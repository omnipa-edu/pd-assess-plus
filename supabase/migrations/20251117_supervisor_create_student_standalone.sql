-- ============================================================================
-- STANDALONE SCRIPT: Create Student Account Function
...
DROP FUNCTION IF EXISTS public.create_student_account(TEXT, TEXT, UUID);
...
WHERE routine_schema = 'public' 
  AND routine_name = 'create_student_account';
